...
import { parseTaskRows, mergeTaskWriteback } from "@aiosbrain/foundation/tasks-table";
 ...
 * @returns {{ rel: string, tier: string|null, rows: import("@aiosbrain/foundation/tasks-table").TaskRow[] }}
 */
